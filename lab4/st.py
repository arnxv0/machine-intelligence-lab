...
def test_case2():
    ...
    try:
        print("#####################")
        print(model.k_neighbours(X_train[0:2, :])[0], kneigh_dist)
        print("#####################")
        np.testing.assert_array_almost_equal(
    ...
    try:
        print("#####################")
        print(model.k_neighbours(X_train[0:2, :])[1], kneigh_idx)
        print("#####################")
        np.testing.assert_array_equal(
    ...
    try:
        print("#####################")
        print(model.predict(X_test), pred)
        print("#####################")
        np.testing.assert_array_equal(
    ...
    try:
        print("#####################")
        print(model.evaluate(X_test, y_test), 60)
        print("#####################")
